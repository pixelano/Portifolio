...
{
    public List<sudoku_modulo> modulos;
    ...
    public void iniciar(sudoki_Cluester aux, int aaa)
    {
    ...
    public sudoku(sudoki_Cluester aux,int aaa){
...
modulos = aux2.Lista;
    ...
    public bool novaestrutura(sudoku_modulo aux,Vector3 auxV)
    {
    ...
    private void criarEstrutura (ConstrutorSudoku constucto ,int indice,Vector3 local)
    {
      ...
      //  constucto.probabilidades.Clear();
       ...
       // constucto.probabilidades.Add(modulos[indice]);
        ...
        constucto.alvo = Instantiate(modulos[indice].modulo,local, Quaternion.identity);
   ...
   private void criarEstrutura (ConstrutorSudoku constucto ,int indice)
    {
      ...
      //  constucto.probabilidades.Clear();
       ...
       // constucto.probabilidades.Add(modulos[indice]);
        ...
        constucto.verificado = false;
        constucto.alvo = Instantiate(modulos[indice].modulo,new Vector3(constucto.indice.x,0,constucto.indice.y), Quaternion.identity);
